...
namespace ConsoleApp7
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            DrawSurroundingSquares(Render, 500, 500, 100,100 ,75, 3);
            Render.Write();
        }
        ...
        private static void DrawSurroundingSquares(Drawing Render, int x, int y,  int Width, int Height, int size, int depth)
        {
            ...
            int y1 = (int)(y - dist * 2.5);//c6 | 1
            int x2 = (int)(x + dist * 2);//c7 | 1
            int y2 = (int)(y - dist * 2.5);//c8 | 1
            int x3 = (int)(x + dist * 0.4);//c9 | 1
            int y3 = (int)(y + dist * 3.2);//c10 | 1
            int x4 = (int)(x - dist * 3);//c11 | 1
            int y4 = (int)(y + dist * 1.5);//c12 | 1
            int x5 = (int)(x + dist * 3);//c13 | 1
            ...
            DrawSurroundingSquares(Render, x1, y1, Width /4, Height/4, size / 4, depth - 1);// T(
            DrawSurroundingSquares(Render, x2, y2, Width / 4, Height / 4, size / 4, depth - 1);
            DrawSurroundingSquares(Render, x3, y3, Width / 4, Height /4, size / 4, depth - 1);
            DrawSurroundingSquares(Render, x4, y4, Width / 4, Height / 4, size / 4, depth - 1);
            DrawSurroundingSquares(Render, x5, y5, Width / 4, Height / 4, size / 4, depth - 1);
